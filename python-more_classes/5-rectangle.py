#!/usr/bin/python3
"""
Rectangle class with private width/height, validated property setters,
area(), perimeter(), __str__ printing using '#', __repr__ for eval(),
and __del__ printing 'Bye rectangle...' on instance deletion.
"""
